defmodule Paraaz.Domain.User do
    ...
    defp add_notifications(existing_notifications, new_notification) when is_nil(existing_notifications) do
        [new_notification]
    end

    defp add_notifications(existing_notifications, new_notification) when is_nil(new_notification) do
